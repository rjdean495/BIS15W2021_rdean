...
```
The data appears tidy as each observation has its own row, rach variable has its own column and each values has its own cell.
...
## # ... with 151 more rows
```
Claremont has the highest average cost. Claremont is a suburban city on the eastern edge of Los Angeles.
...
There is a negative correlation between admission rate and 4 year degree completion 
...
There appears to be a positive correlation between cost and 4 year degree completion.
...
Berkely has the lowest rates of admission (elitists, smh).
</div>
