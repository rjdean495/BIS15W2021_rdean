...
```
## here() starts at D:/TA files/Winter2021 BIS15L/students_rep/BIS15W2021_rdean
```
...
Yes, this data is "tidy" each variable has its own column and each obseration has its own row. Additionally, each value has its own cell. This is in long format.
