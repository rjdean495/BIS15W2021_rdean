...
```
```{r}
filter(fish, lakeid == "BO" & length > 320)
```
...
```{r}
mammal_genus<-select(mammals,genus, mass, gestation, newborn)
primates<-filter(mammal_genus, genus %in% c("Lophocebus", "Erthrocebus", "Macaca"))
primates
```
