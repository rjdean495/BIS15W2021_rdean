...
3. How do you interpret this result? What does this mean about NAs?  NA means that there is a missing value in the data set or a value in the data set is not an integar.

4. Recalculate the mean using the following code chunk. Why is the useful?  
This tells the program to ignore or remove any non-integar values within the data set.
```{r}
