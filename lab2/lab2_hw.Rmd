...
A data matris is a collection of data points arranged in rows and columns for organizational purposes
...
```{r}
hist(Avg.)
plot(Avg.,main="Average Spring Temperatures", ylab="Temperature (C)", xlab= "Spring Number")
```
